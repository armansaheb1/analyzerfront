<template>
  ...
  <div v-if="!idea && !result" style="margin: 2.5%">
    ...
    <button @click="idea = true" style="width: 48%; margin: 1%" class="btn btn-info">
      ایده پردازی
    </button>
    <a href="/" style="width: 48%; margin: 1%" class="btn btn-primary">نوشتن محتوا</a>
  </div>

  <div v-if="!idea && !result && selectedService" style="margin: 2.5%">
    <div>
